...
Public Class RptAutorizacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.RptAutorizacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptAutorizacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptAutorizacion = New RptAutorizacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
