...
Public Class frmAsientoVentaGeneracionAutomatica
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmAsientoVentaGeneracionAutomatica))
        ...
        Me.TituloModulo.Text = "Asiento de venta "
        '
        'ToolBarBuscar
        '
        ...
        'ToolBar1
        '
        Me.ToolBar1.Location = New System.Drawing.Point(0, 418)
        ...
        Me.btnGenerarVenta.Text = "Generar Asiento Venta"
        '
        'Label9
        '
        ...
        Me.Label9.Location = New System.Drawing.Point(104, 384)
        ...
        Me.txtUsuario.Location = New System.Drawing.Point(104, 400)
        ...
        Me.txtClave.Location = New System.Drawing.Point(24, 400)
        ...
        Me.Label10.Location = New System.Drawing.Point(24, 384)
        ...
        Me.griDetalle.Location = New System.Drawing.Point(8, 184)
        Me.griDetalle.MainView = Me.GridView1
        Me.griDetalle.Name = "griDetalle"
        Me.griDetalle.Size = New System.Drawing.Size(600, 168)
        ...
        Me.btnGenerarCostoVenta.Text = "Generar Asiento Costo Venta"
        '
        'txtTotalHaber
        '
        ...
        Me.Label6.Location = New System.Drawing.Point(464, 112)
        ...
        Me.txtDescripcion.Location = New System.Drawing.Point(176, 128)
        ...
        Me.txtCodigo.Location = New System.Drawing.Point(24, 128)
        ...
        'btnModificar
        '
        Me.btnModificar.Location = New System.Drawing.Point(272, 152)
        ...
        Me.txtHaber.Location = New System.Drawing.Point(464, 128)
        ...
        Me.txtDebe.Location = New System.Drawing.Point(328, 128)
        ...
        '
        'frmAsientoVentaGeneracionAutomatica
        '
        ...
        Me.Name = "frmAsientoVentaGeneracionAutomatica"
        Me.Text = "Asiento de venta: Generación automática de asiento"
...
" 'Asiento de venta','Asiento automático ventas desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.Ventas SET Contabilizado = 1 ,asientoventa  = " & NumAsiento & "  WHERE Anulado = 0 AND Contabilizado = 0 AND " & _
    ...
    Private Sub RegistrarDetalleAsiento1(ByVal pNumAsiento As Double)
        ...
        For n = 0 To 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático ventas desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        For n = 3 To 6
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático ventas desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(7)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático ventas desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
" VALUES('" & dtpFechaFinal.Value.Date & "',9999,'BENE',9999, " & _
" '" & Accion & "',0,'" & Date.Now.Date & "',0,'" & periodo & "',0, " & _
" 'Asiento de venta','Asiento automático costo de ventas desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.Ventas SET ContabilizadoCVenta = 1 ,AsientoCosto  = " & NumAsiento & "  WHERE Anulado = 0 AND ContabilizadoCVenta = 0 AND " & _
                " fecha >= " & fecIni & " and fecha <= " & fecFin
    ...
    Private Sub RegistrarDetalleAsiento2(ByVal pNumAsiento As Double)
        ...
        With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(0)
            cnnConexion.Open()
            sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
            " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático costo de ventas desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
            clsConexion.SlqExecute(cnnConexion, sql)
            cnnConexion.Close()
        End With
        ...
        With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(1)
            cnnConexion.Open()
            sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
            " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático costo de ventas desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
            clsConexion.SlqExecute(cnnConexion, sql)
            cnnConexion.Close()
        End With
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(2)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático costo de ventas desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
#Region "Funciones Llenar"
    ...
    Private Sub LlenarGriDetalleAsiento1()
        ...
        sql = " ( " & _
                ...
                " ( SELECT ISNULL(SUM(V.Imp_Venta*V.Tipo_Cambio),0)*100/13 FROM SeePOS.dbo.Ventas V WHERE V.Contabilizado = 0 AND Anulado = 0 AND V.fecha >= " & fecIni & " and V.fecha <= " & fecFin & " ) as Haber " & _
                ...
                " ( SELECT ISNULL(sum(V.SubTotal-v.Descuento+Transporte-((V.Imp_Venta*100/13*V.Tipo_Cambio))),0) FROM SeePOS.dbo.Ventas V WHERE V.Contabilizado = 0 AND Anulado = 0 AND V.fecha >= " & fecIni & " and V.fecha <= " & fecFin & ")as Haber " & _
                "  from Contabilidad.dbo.CuentaContable C " & _
                ...
                " UNION " & _
                " ( " & _
                " select 3 AS ID, C.CuentaContable AS Codigo,C.Descripcion,0 as Debe ,  " & _
                " ( SELECT ISNULL(SUM(V.Imp_Venta*V.Tipo_Cambio),0) FROM SeePOS.dbo.Ventas V WHERE V.Contabilizado = 0 AND Anulado = 0 AND  V.fecha >= " & fecIni & " and V.fecha <= " & fecFin & " ) as Haber " & _
                " from  Contabilidad.dbo.CuentaContable C " & _
                ...
                " (  " & _
                " SELECT ISNULL(SUM(MontoPago*TipoCambio),0)  " & _
                " FROM SeePOS.dbo.OpcionesDePago  " & _
                " WHERE TipoDocumento ='FVC' AND FormaPago = 'EFE'  " & _
                " AND DOCUMENTO IN (select V.Num_Factura from SeePOS.dbo.Ventas V  " & _
                " WHERE  V.Contabilizado = 0 and  V.TIPO = 'CON' AND V.Anulado = 0 AND V.fecha >= " & fecIni & " and V.fecha <= " & fecFin & ") " & _
                ...
                " UNION " & _
                " ( " & _
                " Select 5 AS ID,C.CuentaContable AS Codigo,C.Descripcion, " & _
                " ( " & _
                " SELECT ISNULL(SUM(MontoPago*TipoCambio),0)  " & _
                " FROM SeePOS.dbo.OpcionesDePago  " & _
                " WHERE TipoDocumento ='FVC' AND FormaPago = 'CHE'  " & _
                " AND DOCUMENTO IN (select V.Num_Factura from SeePOS.dbo.Ventas V  " & _
                " WHERE  V.Contabilizado = 0 and  V.TIPO = 'CON' AND V.Anulado = 0 AND V.fecha >= " & fecIni & " and V.fecha <= " & fecFin & ") " & _
                " ) as Debe, 0 as Haber " & _
                " from Contabilidad.dbo.CuentaContable C " & _
                ...
                " UNION " & _
                " ( " & _
                " select 6 AS ID,C.CuentaContable AS Codigo,C.Descripcion, " & _
                " ( " & _
                " SELECT ISNULL(SUM(MontoPago*TipoCambio),0)  " & _
                " FROM SeePOS.dbo.OpcionesDePago  " & _
                " WHERE TipoDocumento ='FVC' AND FormaPago = 'TAR'  " & _
                " AND DOCUMENTO IN (select V.Num_Factura from SeePOS.dbo.Ventas V  " & _
                " WHERE  V.Contabilizado = 0 and  V.TIPO = 'CON' AND V.Anulado = 0 AND V.fecha >= " & fecIni & " and V.fecha <= " & fecFin & ") " & _
                " ) as debe, 0 as haber   " & _
                " from Contabilidad.dbo.CuentaContable C " & _
                ...
                " UNION " & _
                " ( " & _
                " select 7 AS ID,C.CuentaContable as Codigo,C.Descripcion, " & _
                " (SELECT ISNULL(SUM(V.Total*V.Tipo_Cambio),0)  FROM SeePOS.dbo.Ventas  V WHERE V.Contabilizado = 0 AND Anulado = 0 AND  V.fecha >= " & fecIni & " and V.fecha <= " & fecFin & " AND V.Tipo = 'CRE') as Debe, " & _
                "  0 as Haber " & _
                " from  Contabilidad.dbo.CuentaContable C " & _
...
" (  " & _
" select isnull(sum(Cantidad*Precio_Costo*vd.Tipo_Cambio_ValorCompra),0) " & _
" from SeePOS.dbo.Ventas V ,SeePOS.dbo.Ventas_Detalle VD   " & _
" WHERE V.Id = vd.id_factura and  V.ContabilizadoCVenta = 0 AND Anulado = 0 AND V.fecha >= " & fecIni & " and V.fecha <= " & fecFin & " " & _
" ) as debe, 0 as haber " & _
" from  Contabilidad.dbo.CuentaContable C " & _
