...
Public Class frmAjusteCuentaCobrarGeneracionAutomatica
    Inherits Plantilla
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmAjusteCuentaCobrarGeneracionAutomatica))
        ...
        Me.TituloModulo.Text = "Ajuste de cuenta por cobrar"
        '
        'ToolBarBuscar
        '
        ...
        'ToolBar1
        '
        Me.ToolBar1.Location = New System.Drawing.Point(0, 428)
        ...
        Me.txtTotalHaber.Location = New System.Drawing.Point(472, 360)
        ...
        Me.txtTotalDebe.Location = New System.Drawing.Point(320, 360)
        ...
        Me.btnGenerarCostoVenta.Location = New System.Drawing.Point(368, 72)
        ...
        'btnGenerarVenta
        '
        Me.btnGenerarVenta.Location = New System.Drawing.Point(368, 40)
        ...
        'btnModificar
        '
        Me.btnModificar.Location = New System.Drawing.Point(288, 160)
        Me.btnModificar.Name = "btnModificar"
        Me.btnModificar.TabIndex = 9
        Me.btnModificar.Text = "Agregar"
        '
        'frmAjusteCuentaCobrarGeneracionAutomatica
        '
        ...
        Me.Name = "frmAjusteCuentaCobrarGeneracionAutomatica"
...
#Region "Funciones Basicas"
    ...
    Private Function Buscar() As Boolean
        ...
        sql = " SELECT c.id " & _
" FROM seepos.dbo.ajustesccobrar AC, seepos.dbo.detalle_ajustesccobrar DC " & _
...
" 'Asiento ajuste de cuenta por cobrar','Asiento automático ajuste de cuenta por cobrar débito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.ajustesccobrar SET Contabilizado = 1 ,asiento  = " & NumAsiento & "  WHERE Contabilizado = 0 and anula = 0  AND Tipo = 'DEB' AND  " & _
    ...
    Private Sub RegistrarDetalleAsiento1(ByVal pNumAsiento As Double)
        ...
        With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
            ...
            " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático ajuste de cuenta por cobrar desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
            clsConexion.SlqExecute(cnnConexion, sql)
            cnnConexion.Close()
        End With
        ...
        For n = 1 To dtsAsientoVenta.GeneracionAutomaticaAsientoVenta.Count - 1 - m
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático ajuste de cuenta por cobrar desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático ajuste de cuenta por cobrar desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
" VALUES('" & dtpFechaFinal.Value.Date & "',9999,'BENE',9999, " & _
" '" & Accion & "',0,'" & Date.Now.Date & "',0,'" & periodo & "',0, " & _
" 'Asiento ajuste de cuenta por cobrar','Asiento automático ajuste de cuenta por cobrar crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.ajustesccobrar SET Contabilizado = 1 ,asiento  = " & NumAsiento & "  WHERE Contabilizado = 0 and anula = 0  AND Tipo = 'CRE' AND  " & _
                 " fecha >= " & fecIni & " and fecha <= " & fecFin
    ...
    Private Sub RegistrarDetalleAsiento2(ByVal pNumAsiento As Double)
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático ajuste de cuenta por cobrar crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
