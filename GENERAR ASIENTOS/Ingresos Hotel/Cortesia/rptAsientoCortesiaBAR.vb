...
Public Class rptAsientoCortesiaBAR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAsientoCortesiaBAR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.rptAsientoCortesiaBAR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAsientoCortesiaBAR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAsientoCortesiaBAR = New rptAsientoCortesiaBAR()
        rpt.Site = Me.Site
        Return rpt
    End Function
