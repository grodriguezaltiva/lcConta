...
Public Class rptAsientoCortesia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.rptAsientoCortesia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAsientoCortesia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAsientoCortesia = New rptAsientoCortesia()
        rpt.Site = Me.Site
        Return rpt
    End Function
