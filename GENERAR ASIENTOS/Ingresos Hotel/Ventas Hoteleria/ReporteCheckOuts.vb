...
Public Class ReporteCheckOuts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.ReporteCheckOuts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteCheckOuts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCheckOuts = New ReporteCheckOuts()
        rpt.Site = Me.Site
        Return rpt
    End Function
