...
Public Class frmChequeGeneracionAutomatica
    Inherits Plantilla
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmChequeGeneracionAutomatica))
        ...
        'ToolBar1
        '
        Me.ToolBar1.Location = New System.Drawing.Point(0, 380)
        ...
        Me.dtpFechaFinal.Value = New Date(2007, 8, 15, 0, 0, 0, 0)
        '
        'dtpFechaInicio
        '
        ...
        Me.dtpFechaInicio.Value = New Date(2007, 8, 15, 0, 0, 0, 0)
        '
        'dtsAsientoVenta
        '
        ...
        '
        'frmChequeGeneracionAutomatica
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.BackgroundImage = CType(resources.GetObject("$this.BackgroundImage"), System.Drawing.Image)
        Me.ClientSize = New System.Drawing.Size(634, 432)
        ...
        Me.Name = "frmChequeGeneracionAutomatica"
...
#Region "Funciones Basicas"
    ...
    Private Function Buscar() As Boolean
        ...
        If caso = 0 Then
          ...
          " AND Che.id_cheque = ched.id_cuentabancaria " & _
          ...
          " group by c.id"
            ...
            sql = " SELECT C.id " & _
" FROM contabilidad.dbo.cuentacontable c, Bancos.dbo.Cheques Che, Bancos.dbo.Cheques_Detalle CheD " & _
" WHERE Che.Anulado = 0 and che.Contabilizado = 0 " & _
" AND Che.fecha >= " & fecIni & _
" and Che.fecha <= " & fecFin & _
    ...
    Private Sub RegistrarDetalleAsiento1(ByVal pNumAsiento As Double)
        ...
        For n = 0 To IdCuenta1a.Length - 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático cheques desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        For n = 0 To IdCuenta1b.Length - 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n + m)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático cheques desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n + m)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático cheques desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
#Region "Funciones Llenar"
    ...
    " (  " & _
 " SELECT isnull(sum( MontoColones = CASE Che.CodigoMoneda WHEN 1 THEN Che.Monto ELSE che.Monto * che.TipoCambio END),0) " & _
...
" (  " & _
" SELECT isnull(Min(che.monto),0) " & _
" FROM Bancos.dbo.Cheques Che,Bancos.dbo.Cheques_Detalle CheD " & _
" WHERE Che.Anulado = 0 and che.Contabilizado = 0 " & _
" AND Che.fecha >=  " & fecIni & _
" and Che.fecha <= " & fecFin & _
" AND Che.id_cheque = ched.id_cheque " & _
