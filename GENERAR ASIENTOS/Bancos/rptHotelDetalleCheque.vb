...
Public Class rptHotelDetalleCheque
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptHotelDetalleCheque.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.rptHotelDetalleCheque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHotelDetalleCheque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHotelDetalleCheque = New rptHotelDetalleCheque()
        rpt.Site = Me.Site
        Return rpt
    End Function
