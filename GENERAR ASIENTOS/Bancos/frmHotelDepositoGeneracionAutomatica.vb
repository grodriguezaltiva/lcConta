...
Public Class frmHotelDepositoGeneracionAutomatica
    Inherits Plantilla
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmHotelDepositoGeneracionAutomatica))
        ...
        'ToolBar1
        '
        Me.ToolBar1.Location = New System.Drawing.Point(0, 374)
        ...
        Me.txtDescripcion.TabIndex = 240
        ...
        Me.txtUsuario.Location = New System.Drawing.Point(429, 401)
        Me.txtUsuario.Name = "txtUsuario"
        Me.txtUsuario.ReadOnly = True
        Me.txtUsuario.Size = New System.Drawing.Size(192, 14)
        Me.txtUsuario.TabIndex = 248
        Me.txtUsuario.Text = ""
        '
        'txtClave
        '
        ...
        Me.txtClave.Location = New System.Drawing.Point(349, 401)
        ...
        Me.Label9.Location = New System.Drawing.Point(429, 385)
        ...
        Me.Label10.Location = New System.Drawing.Point(349, 385)
        ...
        'btnDetalle
        '
        Me.btnDetalle.Location = New System.Drawing.Point(19, 348)
        Me.btnDetalle.Name = "btnDetalle"
        Me.btnDetalle.TabIndex = 256
        Me.btnDetalle.Text = "Detalle"
        '
        'frmHotelDepositoGeneracionAutomatica
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.BackgroundImage = CType(resources.GetObject("$this.BackgroundImage"), System.Drawing.Image)
        Me.ClientSize = New System.Drawing.Size(630, 426)
        ...
        Me.Name = "frmHotelDepositoGeneracionAutomatica"
...
" group by c.id "
    ...
    Private Sub RegistrarAsiento1()
        ...
        If MsgBox("Desea Guardar asiento de Deposito", MsgBoxStyle.OKCancel) = MsgBoxResult.Cancel Then
            Exit Sub
        End If
...
" VALUES('" & NumAsiento & "','" & Format(dtpFechaFinal.Value.Date, "yyyy/dd/MM") & "',9999,'BENE',2, " & _
" '" & Accion & "',0,'" & Format(Date.Now.Date, "yyyy/dd/MM") & "',0,'" & periodo & "',0, " & _
...
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & "," & TipoCambio & ") "
        ...
        'sql = "SELECT MAX(NumAsiento) FROM AsientosContables WHERE Fecha = '" & Format(dtpFechaFinal.Value.Date, "yyyy/dd/MM") & "' AND Periodo = '" & periodo & "' and NombreUsuario = '" & txtUsuario.Text & "'"
        'rstReader = clsConexion.GetRecorset(cnnConexion, sql)
        'rstReader.Read()
        ...
        For n = 0 To Me.dtsAsientoVenta.GeneracionAutomaticaAsientoVenta.Count - 1
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                If monto <> 0 Then
                    ...
                    " VALUES('" & pNumAsiento & "','" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático depósitos desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "'," & TipoCambiod & ") "
                    clsConexion.SlqExecute(cnnConexion, sql)
                    cnnConexion.Close()
                End If
            End With
...
" where Movimiento=1 " '"select CuentaContable AS [Codigo cuenta],descripcion as Descripcion from Contabilidad.dbo.CuentaContable where  Movimiento = 1  "
    ...
    Private Sub Reporte()
        Try
            Dim reporte As New rptHotelDetalleDeposito_Generado
            ...
            'reporte.RecordSelectionFormula = " {Deposito.Fecha} in " & fecIni & "  to " & fecFin & "  and {Deposito.Asiento} = 0 and not {Deposito.Anulado} "
