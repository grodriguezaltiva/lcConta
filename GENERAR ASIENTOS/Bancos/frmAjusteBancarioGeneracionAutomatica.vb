...
Public Class frmAjusteBancarioGeneracionAutomatica
    Inherits Plantilla
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmAjusteBancarioGeneracionAutomatica))
        ...
        Me.btnGenerarCostoVenta.TabIndex = 217
        Me.btnGenerarCostoVenta.Text = "Genrar asiento debito"
        '
        'griDetalle
        '
        ...
        '
        'frmAjusteBancarioGeneracionAutomatica
        '
        ...
        Me.Name = "frmAjusteBancarioGeneracionAutomatica"
...
#Region "Funciones Basicas"
   ...
   " and Che.fecha <=  " & fecFin & _
     " AND Che.id_ajuste = ched.id_cuentabancaria " & _
...
" 'Asiento ajuste bancario','Asiento automático ajuste bancario debito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
    ...
    Private Sub RegistrarDetalleAsiento1(ByVal pNumAsiento As Double)
        ...
        For n = 0 To IdCuenta1a.Length - 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático ajuste bancario debito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        For n = 0 To IdCuenta1b.Length - 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n + m)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático ajuste bancario debito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n + m)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático ajuste bancario debito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
    ...
    Private Sub RegistrarDetalleAsiento2(ByVal pNumAsiento As Double)
        ...
        For n = 0 To IdCuenta2a.Length - 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático ajuste bancario crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        For n = 0 To IdCuenta2b.Length - 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n + m)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático ajuste bancario crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n + m)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático ajuste bancario crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
" (  " & _
" SELECT isnull(sum(che.monto),0) " & _
...
" (  " & _
" SELECT isnull(sum(ched.monto),0) " & _
