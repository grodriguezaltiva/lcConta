...
Public Class frmDepositoGeneracionAutomatica
    Inherits Plantilla
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmDepositoGeneracionAutomatica))
        ...
        Me.txtHaber.Location = New System.Drawing.Point(480, 136)
        ...
        Me.txtCodigo.Location = New System.Drawing.Point(40, 136)
        ...
        Me.txtDebe.Location = New System.Drawing.Point(344, 136)
        ...
        Me.txtDebe.TabIndex = 220
        '
        'txtDescripcion
        '
        Me.txtDescripcion.AutoSize = False
        Me.txtDescripcion.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        Me.txtDescripcion.Location = New System.Drawing.Point(192, 136)
        Me.txtDescripcion.Name = "txtDescripcion"
        Me.txtDescripcion.ReadOnly = True
        Me.txtDescripcion.Size = New System.Drawing.Size(148, 19)
        Me.txtDescripcion.TabIndex = 219
        ...
        Me.Label5.Location = New System.Drawing.Point(344, 120)
        ...
        Me.griDetalle.Location = New System.Drawing.Point(24, 192)
        ...
        'btnGenerarVenta
        '
        Me.btnGenerarVenta.Location = New System.Drawing.Point(376, 48)
        ...
        Me.btnGenerarVenta.Text = "Generarar asiento "
        '
        'dtpFechaFinal
        '
        Me.dtpFechaFinal.Format = System.Windows.Forms.DateTimePickerFormat.Short
        Me.dtpFechaFinal.Location = New System.Drawing.Point(256, 80)
        ...
        Me.dtpFechaInicio.Location = New System.Drawing.Point(256, 48)
        ...
        '
        'frmDepositoGeneracionAutomatica
        '
        ...
        Me.Name = "frmDepositoGeneracionAutomatica"
        Me.Text = "Deposito: Generación automática de asiento"
...
#Region "Funciones GUI"
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerarVenta.Click
        ...
        If Buscar() = False Then
            MsgBox("No se encontraron cuentas de depósito para esta fecha")
            Exit Sub
        End If
...
#Region "Funciones Basicas"
    ...
    Private Function Buscar() As Boolean
        ...
        If caso = 0 Then
            ...
            sql = " SELECT C.id " & _
" FROM contabilidad.dbo.cuentacontable c, Bancos.dbo.deposito Che, Bancos.dbo.Cuentas_Bancarias CheD " & _
" WHERE Che.Anulado = 0 and che.Contabilizado = 0 " & _
" AND Che.fecha >=  " & fecIni & _
" and Che.fecha <=  " & fecFin & _
" AND Che.id_deposito = ched.id_cuentabancaria " & _
...
" group by c.id "
            ...
            sql = " SELECT C.id " & _
" FROM contabilidad.dbo.cuentacontable c, Bancos.dbo.deposito Che, Bancos.dbo.Deposito_Detalle CheD " & _
" WHERE Che.Anulado = 0 and che.Contabilizado = 0 " & _
" AND Che.fecha >= " & fecIni & _
" and Che.fecha <= " & fecFin & _
" AND Che.id_deposito = ched.id_deposito " & _
" and c.cuentacontable = ched.cuentacontable  COLLATE Traditional_Spanish_CI_AS " & _
" group by c.id "
            rstReader = clsConexion.GetRecorset(cnnConexion, sql)
...
" 'Asiento depósitos','Asiento automático depósitos desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE Bancos.dbo.deposito SET Contabilizado = 1 ,asiento  = " & NumAsiento & "  WHERE Contabilizado = 0 and anulaDO = 0  AND  " & _
    ...
    Private Sub RegistrarDetalleAsiento1(ByVal pNumAsiento As Double)
        ...
        For n = 0 To IdCuenta1a.Length - 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático depósitos desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        For n = 0 To IdCuenta1b.Length - 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n + m)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático depósitos desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n + m)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático depósitos desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
" FROM Bancos.dbo.deposito Che,Bancos.dbo.Cuentas_bancarias CheD " & _
" WHERE Che.Anulado = 0 and che.Contabilizado = 0 " & _
" AND Che.fecha >=  " & fecIni & _
" and Che.fecha <=  " & fecFin & _
" AND Che.id_deposito = ched.id_cuentabancaria " & _
...
" (  " & _
" SELECT isnull(sum(case che.CodigoMoneda when 1 then che.monto else che.monto*che.TipoCambio END),0) " & _
" FROM Bancos.dbo.deposito Che,Bancos.dbo.Deposito_Detalle CheD " & _
" WHERE Che.Anulado = 0 and che.Contabilizado = 0 " & _
" AND Che.fecha >=  " & fecIni & _
" and Che.fecha <= " & fecFin & _
" AND Che.id_deposito = ched.id_deposito " & _
