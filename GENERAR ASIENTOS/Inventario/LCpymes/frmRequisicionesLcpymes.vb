...
Public Class frmRequisicionesLcpymes
...
#Region "Funciones Basicas"
    ...
    Private Function Buscar() As Boolean
        ...
        sql = " SELECT B.Id_Bodega " & _
" FROM SeePos.dbo.Bodegas B, SeePos.dbo.Requisiciones R  " & _
" WHERE  r.Anulado = 0 And Contabilizado = 0 " & _
"  AND r.fecha >= " & fecIni & _
"  and r.fecha <= " & fecFin & _
" And r.BodegaOrigen = B.iD_bODEGA " & _
...
" SeePos.dbo.Requisiciones R , SeePos.dbo.RequisicionesDetalles RD, " & _
...
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ", " & Fx.TipoCambio(dtpFechaFinal.Value) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePos.dbo.Requisiciones SET Contabilizado = 1 ,asiento  = '" & NumAsiento & "'  WHERE Contabilizado = 0 AND " & _
...
" ( " & _
" select isnull(SUM(PrecioBase*TipoCambio*Cantidad),0) from SeePos.dbo.Requisiciones R , SeePos.dbo.RequisicionesDetalles RD " & _
" WHERE  r.Anulado = 0 And Contabilizado = 0 " & _
" AND r.fecha >=  " & fecIni & _
" and r.fecha <= " & fecFin & _
...
" AND r.fecha >=  " & fecIni & _
" and r.fecha <= " & fecFin & _
" AND RD.Id_Requisicion = r.Id_Requisicion AND R.BodegaOrigen = B.Id_Bodega )  as Haber " & _
" from  Contabilidad.dbo.CuentaContable C, SeePos.dbo.Bodegas B " & _
" WHERE C.CuentaContable collate Modern_Spanish_CI_AS = B.CuentaContable AND B.Id_Bodega = " & IdCuenta1a(n) & _
" GROUP BY C.CuentaContable,C.Descripcion,B.Id_Bodega " & _
    " ) "
        Next
...
#Region "Reporte"
    ...
    Private Sub Reporte()
        Try
            Dim reporteRequiscion As New rptDetalleRequisicionLcPymes
            ...
            If caso = 0 Then
                ...
                CrystalReportsConexion2.LoadReportViewer2(visor.rptViewer, reporteRequiscion, False, Configuracion.Claves.Conexion("SeePos"))
            End If
            visor.Show()
