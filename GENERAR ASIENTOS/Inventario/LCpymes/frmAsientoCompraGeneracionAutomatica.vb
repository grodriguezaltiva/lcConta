...
Imports Utilidades
Public Class frmAsientoCompraGeneracionAutomatica
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmAsientoCompraGeneracionAutomatica))
        ...
        Me.TituloModulo.Text = "Asiento de compra"
        '
        'ToolBarBuscar
        '
        ...
        Me.txtDescripcion.Location = New System.Drawing.Point(177, 136)
        ...
        Me.Label4.Location = New System.Drawing.Point(177, 120)
        ...
        'btnModificar
        '
        Me.btnModificar.Location = New System.Drawing.Point(268, 160)
        ...
        '
        'frmAsientoCompraGeneracionAutomatica
        '
        ...
        Me.Name = "frmAsientoCompraGeneracionAutomatica"
        Me.Text = "Asiento de compra: Generación automática de asiento"
...
#Region "Funciones Basicas"
    ...
    Private Sub Buscar()
        ...
        Dim sql As String = "SELECT IdCompraGrabado,IdCompraExcento,IdImpuestoVenta,IdInventario FROM  contabilidad.dbo.SettingCuentaContable"
...
" 'Asiento de compra','Asiento automático compra desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.compras SET Contabilizado = 1 ,asiento  = " & NumAsiento & "  WHERE Contabilizado = 0 AND " & _
    ...
    Private Sub RegistrarDetalleAsiento1(ByVal pNumAsiento As Double)
        ...
        For n = 3 To 3
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático compra desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
...
" VALUES('" & dtpFechaFinal.Value.Date & "',9999,'BENE',9999, " & _
" '" & Accion & "',0,'" & Date.Now.Date & "',0,'" & periodo & "',0, " & _
" 'Asiento de compra','Asiento automático compra inventario desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.compras SET ContaInve = 1 ,AsientoInve  = " & NumAsiento & "  WHERE ContaInve = 0 AND " & _
                " fecha >= " & fecIni & " and fecha <= " & fecFin
...
" (  " & _
" SELECT ISNULL(SUM(SubTotalGravado*Cod_MonedaCompra),0) FROM SeePOS.dbo.Compras V WHERE  " & _
" V.Contabilizado = 0 and v.TipoCompra = 'CRE'  " & _
...
" (  " & _
" SELECT ISNULL(SUM(SubTotalExento*Cod_MonedaCompra),0) FROM SeePOS.dbo.Compras V WHERE  " & _
" V.Contabilizado = 0  and v.TipoCompra = 'CRE' " & _
"  AND v.fecha >= " & fecIni & _
"  and v.fecha <=  " & fecFin & _
" ) as Debe, 0 as Haber " & _
...
" (  " & _
" SELECT ISNULL(SUM(Impuesto*Cod_MonedaCompra),0) FROM SeePOS.dbo.Compras V WHERE  " & _
" V.Contabilizado = 0  and v.TipoCompra = 'CRE' " & _
"  AND v.fecha >= " & fecIni & _
"  and v.fecha <=  " & fecFin & _
" ) as Debe, 0 as Haber " & _
...
" (  " & _
" SELECT ISNULL(SUM(TotalFactura*Cod_MonedaCompra),0) FROM SeePOS.dbo.Compras V WHERE  " & _
" V.Contabilizado = 0 and v.TipoCompra = 'CRE' " & _
"  AND v.fecha >= " & fecIni & _
"  and v.fecha <=  " & fecFin & _
" ) as Haber " & _
...
" (  " & _
" SELECT ISNULL(SUM(SubTotalExento*Cod_MonedaCompra),0) FROM SeePOS.dbo.Compras V WHERE  " & _
" V.ContaInve = 0   and v.TipoCompra = 'CRE'" & _
"  AND v.fecha >= " & fecIni & _
"  and v.fecha <=  " & fecFin & _
" ) as haber " & _
" from  Contabilidad.dbo.CuentaContable C " & _
...
" select 3 as id, C.CuentaContable AS Codigo,C.Descripcion, " & _
" (  " & _
" SELECT ISNULL(SUM((SubTotalExento+subtotalgravado)*Cod_MonedaCompra),0) FROM SeePOS.dbo.Compras V WHERE  " & _
" V.ContaInve = 0  and v.TipoCompra = 'CRE' " & _
"  AND v.fecha >= " & fecIni & _
"  and v.fecha <=  " & fecFin & _
"  ) as Debe, 0 as Haber " & _
