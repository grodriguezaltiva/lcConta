...
Public Class frmDevolucionCompraGeneracionAutomatica
    Inherits Plantilla
    ...
    Dim IdCuenta2(3) As Integer   ' saber los ids de las cuentas que correspondes a los asientos de costo de venta guardadas en la tabla de Contabilidad.SettingCuentaFacturaVenta
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmDevolucionCompraGeneracionAutomatica))
        ...
        Me.TituloModulo.Size = New System.Drawing.Size(626, 32)
        ...
        'ToolBar1
        '
        Me.ToolBar1.Location = New System.Drawing.Point(0, 420)
        Me.ToolBar1.Name = "ToolBar1"
        Me.ToolBar1.Size = New System.Drawing.Size(626, 52)
        '
        'ToolBarImprimir
        '
        ...
        'btnModificar
        '
        Me.btnModificar.Location = New System.Drawing.Point(272, 168)
        ...
        '
        Me.btnGenerarCostoVenta.Location = New System.Drawing.Point(360, 88)
        ...
        Me.GridColumn1.SortIndex = 0
        Me.GridColumn1.SortOrder = DevExpress.Data.ColumnSortOrder.Descending
        ...
        Me.griDetalle.Location = New System.Drawing.Point(8, 200)
        ...
        Me.Label9.Location = New System.Drawing.Point(104, 376)
        ...
        Me.dtpFechaFinal.Location = New System.Drawing.Point(240, 88)
        ...
        Me.Label5.Location = New System.Drawing.Point(328, 128)
        ...
        Me.dtpFechaInicio.Location = New System.Drawing.Point(240, 56)
        ...
        Me.txtHaber.Location = New System.Drawing.Point(464, 144)
        ...
        Me.txtDebe.Location = New System.Drawing.Point(328, 144)
        ...
        Me.txtCodigo.Location = New System.Drawing.Point(24, 144)
        ...
        'btnGenerarVenta
        '
        Me.btnGenerarVenta.Location = New System.Drawing.Point(360, 56)
        ...
        Me.Label6.Location = New System.Drawing.Point(464, 128)
        ...
        Me.txtDescripcion.Location = New System.Drawing.Point(176, 144)
        ...
        Me.txtUsuario.Location = New System.Drawing.Point(104, 392)
        Me.txtUsuario.Name = "txtUsuario"
        Me.txtUsuario.ReadOnly = True
        Me.txtUsuario.Size = New System.Drawing.Size(192, 14)
        Me.txtUsuario.TabIndex = 158
        Me.txtUsuario.Text = ""
        '
        'txtClave
        '
        ...
        Me.txtClave.Location = New System.Drawing.Point(24, 392)
        ...
        '
        'frmDevolucionCompraGeneracionAutomatica
        '
        ...
        Me.Name = "frmDevolucionCompraGeneracionAutomatica"
...
#Region "Funciones Basicas"
    ...
    Private Sub Buscar()
        ...
        Dim sql As String = "SELECT IdCompraGrabado,IdCompraExcento,IdImpuestoVenta,IdCuentaPagar,IdInventario FROM  contabilidad.dbo.SettingCuentaContable"
        ...
        IdCuenta1(0) = rstReader("IdCompraGrabado")
        IdCuenta1(1) = rstReader("IdCompraExcento")
        IdCuenta1(2) = rstReader("IdImpuestoVenta")
        IdCuenta1(3) = rstReader("IdCuentaPagar")


        'se buscan los que corresponden al asiento de costo de venta
        IdCuenta2(0) = rstReader("IdCompraGrabado")
        IdCuenta2(1) = rstReader("IdCompraExcento")
        IdCuenta2(2) = rstReader("IdInventario")
...
" 'Devolución de compra','Asiento automático devolución compra desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.devoluciones_Compras SET Contabilizado = 1 ,asiento  = " & NumAsiento & "  WHERE Contabilizado = 0 AND " & _
    ...
    Private Sub RegistrarDetalleAsiento1(ByVal pNumAsiento As Double)
        ...
        For n = 0 To 2
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático devolucion de compra desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        For n = 3 To 3
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático compra desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(4)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático compra desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
" VALUES('" & dtpFechaFinal.Value.Date & "',9999,'BENE',9999, " & _
" '" & Accion & "',0,'" & Date.Now.Date & "',0,'" & periodo & "',0, " & _
" 'Devolución de compras','Asiento automático compra gravada desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.devoluciones_Compras SET ContaInventario = 1 ,AsientoInventario  = " & NumAsiento & "  WHERE ContaInventario = 0 AND " & _
                " fecha >= " & fecIni & " and fecha <= " & fecFin
    ...
    Private Sub RegistrarDetalleAsiento2(ByVal pNumAsiento As Double)
        ...
        For n = 0 To 1
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático compra inventario desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(2)
            cnnConexion.Open()
            sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
            " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático compra inventario desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
            clsConexion.SlqExecute(cnnConexion, sql)
            cnnConexion.Close()
        End With
        ...
        If Accion = "MAN" Then
            Dim debe, haber As Byte
            Dim monto As String
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(3)
                If .Debe = 0 Then
                    haber = 1
                    debe = 0
                    monto = FormatoDouble(.Haber)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático compra inventario desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
" (  " & _
" SELECT ISNULL(SUM(SubTotalGravado*Cod_moneda),0) FROM SeePOS.dbo.devoluciones_Compras V WHERE  " & _
" V.Contabilizado = 0 and V.Anulado = 0  " & _
...
" (  " & _
" SELECT ISNULL(SUM(SubTotalExcento*Cod_moneda),0) FROM SeePOS.dbo.devoluciones_Compras V WHERE  " & _
" V.Contabilizado = 0 and V.Anulado = 0  " & _
"  AND v.fecha >=  " & fecIni & _
"  and v.fecha <= " & fecFin & " )  " & _
" as Haber " & _
...
" (  " & _
" SELECT ISNULL(SUM(impuesto*Cod_moneda),0) FROM SeePOS.dbo.devoluciones_Compras V WHERE  " & _
" V.Contabilizado = 0 and V.Anulado = 0  " & _
"  AND v.fecha >=  " & fecIni & _
"  and v.fecha <=  " & fecFin & " )  " & _
" as Haber " & _
...
" (  " & _
" SELECT ISNULL(SUM(Monto*Cod_moneda),0) FROM SeePOS.dbo.devoluciones_Compras V WHERE  " & _
" V.Contabilizado = 0 and V.Anulado = 0  " & _
"  AND v.fecha >=  " & fecIni & _
"  and v.fecha <=  " & fecFin & " )  " & _
...
" (  " & _
" SELECT ISNULL(SUM(SubTotalGravado*Cod_moneda),0) FROM SeePOS.dbo.devoluciones_Compras V WHERE  " & _
" V.ContaInventario = 0 and V.Anulado = 0  " & _
"  AND v.fecha >= " & fecIni & _
"  and v.fecha <=  " & fecFin & " ) " & _
" as Debe, 0 as haber  " & _
" from  Contabilidad.dbo.CuentaContable C  " & _
...
" select   3 as id,C.CuentaContable AS Codigo,C.Descripcion,0 as debe, " & _
" (  " & _
" SELECT ISNULL(SUM((SubTotalExcento+SubTotalGravado)*Cod_moneda),0) FROM SeePOS.dbo.devoluciones_Compras V WHERE  " & _
" V.ContaInventario = 0 and V.Anulado = 0  " & _
"  AND v.fecha >= " & fecIni & _
"  and v.fecha <= " & fecFin & " ) " & _
" as Haber " & _
" from  Contabilidad.dbo.CuentaContable C  " & _
" where  C.ID = " & IdCuenta2(2) & _
" GROUP BY C.CuentaContable,C.Descripcion " & _
" ) "
        cnnConexion.ConnectionString = Configuracion.Claves.Conexion("Contabilidad")
        cnnConexion.Open()
