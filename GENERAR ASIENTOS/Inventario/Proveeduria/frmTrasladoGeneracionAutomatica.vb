...
Imports Utilidades
Public Class frmTrasladoGeneracionAutomatica
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmTrasladoGeneracionAutomatica))
        ...
        Me.TituloModulo.Text = "Traslados"
        '
        'ToolBar1
        '
        Me.ToolBar1.Location = New System.Drawing.Point(0, 371)
        Me.ToolBar1.Name = "ToolBar1"
        Me.ToolBar1.Size = New System.Drawing.Size(630, 58)
        ...
        Me.txtCodigo.Location = New System.Drawing.Point(31, 129)
        ...
        Me.txtHaber.Location = New System.Drawing.Point(471, 129)
        ...
        Me.txtDebe.Location = New System.Drawing.Point(335, 129)
        ...
        Me.txtDescripcion.Location = New System.Drawing.Point(183, 129)
        ...
        Me.txtTotalHaber.Location = New System.Drawing.Point(471, 345)
        ...
        Me.txtTotalDebe.Location = New System.Drawing.Point(319, 345)
        ...
        Me.Label4.Location = New System.Drawing.Point(183, 113)
        ...
        'btnModificar
        '
        Me.btnModificar.Location = New System.Drawing.Point(279, 153)
        ...
        Me.griDetalle.Location = New System.Drawing.Point(15, 100)
        Me.griDetalle.MainView = Me.GridView1
        Me.griDetalle.Name = "griDetalle"
        Me.griDetalle.Size = New System.Drawing.Size(600, 237)
        ...
        'btnGenerarVenta
        '
        Me.btnGenerarVenta.Location = New System.Drawing.Point(367, 41)
        ...
        Me.dtpFechaFinal.Location = New System.Drawing.Point(247, 73)
        ...
        Me.dtpFechaInicio.Location = New System.Drawing.Point(247, 41)
        ...
        'btnDetalle
        '
        Me.btnDetalle.Location = New System.Drawing.Point(16, 345)
        Me.btnDetalle.Name = "btnDetalle"
        Me.btnDetalle.TabIndex = 237
        Me.btnDetalle.Text = "Detalle"
        '
        'frmTrasladoGeneracionAutomatica
        '
        ...
        Me.Name = "frmTrasladoGeneracionAutomatica"
        Me.Text = "Traslados: Generación automática de asiento"
...
#Region "Funciones Basicas"
    ...
    Private Sub Generar()
        ...
        If Buscar() = False Then
            MsgBox("No se encontraron Traslados para esta fecha")
            Exit Sub
        End If
    ...
    Private Function Buscar() As Boolean
        ...
        sql = " select B.IdBodega from " & _
" Proveeduria.dbo.Traslados T, Proveeduria.dbo.TrasladosDetalle TD, Proveeduria.dbo.Bodega B " & _
" WHERE T.anulado = 0 AND T.Contabilizado = 0 " & _
"  AND t.fecha >= " & fecIni & _
"  and t.fecha <= " & fecFin & _
" AND T.Id_Traslados = TD.Id_Traslados AND T.BodegaOrigen = B.IdBodega " & _
" GROUP BY B.IdBodega "
...
"  AND t.fecha >= " & fecIni & _
"  and t.fecha <= " & fecFin & _
" AND T.Id_Traslados = TD.Id_Traslados AND T.BodegaDestino = B.IdBodega " & _
" GROUP BY B.IdBodega "
    ...
    Private Sub RegistrarAsiento1()
        ...
        If MsgBox("Desea Guardar asiento de Traslado", MsgBoxStyle.OKCancel) = MsgBoxResult.Cancel Then
            Exit Sub
        End If
        fecIni = "  CONVERT(DATETIME, '" & dtpFechaInicio.Value.Year & "-" & dtpFechaInicio.Value.Month & "-" & dtpFechaInicio.Value.Day & " 00:00:00', 102)"
        fecFin = "  CONVERT(DATETIME, '" & dtpFechaFinal.Value.Year & "-" & dtpFechaFinal.Value.Month & "-" & dtpFechaFinal.Value.Day & " 23:59:59', 102)"
...
" VALUES('" & NumAsiento & "','" & dtpFechaFinal.Value.Date & "',9999,'BENE',10, " & _
" '" & Accion & "',0,'" & Date.Now.Date & "',0,'" & periodo & "',0, " & _
" 'Asiento de Traslados','Asiento automático traslados desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ", " & Fx.TipoCambio(dtpFechaFinal.Value) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE Proveeduria.dbo.Traslados SET Contabilizado = 1 ,asiento  = '" & NumAsiento & "'  WHERE Contabilizado = 0 AND " & _
        ...
        For n = 0 To Me.dtsAsientoVenta.GeneracionAutomaticaAsientoVenta.Count - 1
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                If monto <> 0 Then
                    ...
                    " VALUES('" & pNumAsiento & "','" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático traslado desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "', " & Fx.TipoCambio(dtpFechaFinal.Value) & ") "
                    clsConexion.SlqExecute(cnnConexion, sql)
                    cnnConexion.Close()
                End If
            End With
...
" ( " & _
" SELECT ISNULL(SUM(PrecioBase*Cantidad*TipoCambio),0)  " & _
" FROM Proveeduria.dbo.Traslados T, Proveeduria.dbo.TrasladosDetalle TD " & _
" WHERE T.anulado = 0 AND T.Contabilizado = 0 " & _
" AND t.fecha >=  " & fecIni & _
" and t.fecha <= " & fecFin & _
" AND T.Id_Traslados = TD.Id_Traslados AND T.BodegaDestino = B.IdBodega " & _
...
" WHERE C.CuentaContable = B.CuentaContable AND B.IdBodega = " & IdCuenta1b(n) & _
...
#Region "Reporte"
    ...
    Private Sub Reporte()
        Try
            Dim reporteTraslado As New rptProveeduriaTrasladoDetalle
            ...
            If caso = 0 Then
                reporteTraslado.RecordSelectionFormula = "{VistaTraslado.Fecha} in " & fecIni & " to " & fecFin & " and not {VistaTraslado.Anulado} and not {VistaTraslado.Contabilizado}"
                CrystalReportsConexion2.LoadReportViewer2(visor.rptViewer, reporteTraslado, False,Configuracion.Claves.Conexion("Proveeduria"))
            End If
            visor.Show()
