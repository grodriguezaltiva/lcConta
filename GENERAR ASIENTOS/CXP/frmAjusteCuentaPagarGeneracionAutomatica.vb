...
Public Class frmAjusteCuentaPagarGeneracionAutomatica
    Inherits Plantilla
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmAjusteCuentaPagarGeneracionAutomatica))
        ...
        Me.txtTotalHaber.Location = New System.Drawing.Point(464, 352)
        ...
        Me.txtTotalDebe.Location = New System.Drawing.Point(312, 352)
        ...
        Me.txtUsuario.Location = New System.Drawing.Point(104, 384)
        ...
        Me.txtClave.Location = New System.Drawing.Point(24, 384)
        ...
        Me.Label9.Location = New System.Drawing.Point(104, 368)
        ...
        '
        'frmAjusteCuentaPagarGeneracionAutomatica
        '
        ...
        Me.Name = "frmAjusteCuentaPagarGeneracionAutomatica"
...
#Region "Funciones Basicas"
    ...
    Private Function Buscar() As Boolean
        ...
        Dim n As Integer
        Dim sql As String = "SELECT IdCuentaPagar FROM contabilidad.dbo.SettingCuentaContable "
        ...
        IdCuenta1(0) = rstReader("IdCuentaPagar")
        IdCuenta2(0) = rstReader("IdCuentaPagar")
        rstReader.Close()
        ...
        sql = " SELECT c.id " & _
" FROM seepos.dbo.Ajustescpagar AP, seepos.dbo.Detalle_AjustescPagar DP " & _
" ,contabilidad.dbo.cuentacontable c " & _
" WHERE AP.Tipo = 'DEB' AND Anula = 0 and Contabilizado = 0 " & _
...
" FROM seepos.dbo.Ajustescpagar AP, seepos.dbo.Detalle_AjustescPagar DP " & _
" ,contabilidad.dbo.cuentacontable c " & _
" WHERE AP.Tipo = 'CRE' AND Anula = 0 and Contabilizado = 0 " & _
"  AND AP.fecha >= " & fecIni & _
"  and AP.fecha <= " & fecFin & _
" and  AP.Id_ajuste = DP.Id_AjustecPagar " & _
" and c.cuentacontable = DP.cuentacontable  COLLATE Traditional_Spanish_CI_AS " & _
...
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.Ajustescpagar SET Contabilizado = 1 ,asiento  = " & NumAsiento & "  WHERE Contabilizado = 0 AND and anula = 0 and TIPO = 'DEB' AND " & _
    ...
    Private Sub RegistrarDetalleAsiento1(ByVal pNumAsiento As Double)
        ...
        With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
            ...
            " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático ajuste de cuenta por pagar débito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
            clsConexion.SlqExecute(cnnConexion, sql)
            cnnConexion.Close()
        End With
        ...
        For n = 1 To dtsAsientoVenta.GeneracionAutomaticaAsientoVenta.Count - 1 - m
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático ajuste de cuenta por pagar débito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
        ...
        If Accion = "MAN" Then
            ...
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático ajuste de cuenta por pagar débito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        End If
...
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE SeePOS.dbo.Ajustescpagar SET Contabilizado = 1 ,asiento  = " & NumAsiento & "  WHERE Contabilizado = 0 AND and anula = 0 and TIPO = 'CRE' AND " & _
                  " fecha >= " & fecIni & " and fecha <= " & fecFin
    ...
    Private Sub RegistrarDetalleAsiento2(ByVal pNumAsiento As Double)
        ...
        With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
            cnnConexion.Open()
            sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
            " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Debe) & ",1,0,'Asiento automático ajuste de cuenta por pagar crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
            clsConexion.SlqExecute(cnnConexion, sql)
            cnnConexion.Close()
        End With
        ...
        For n = 1 To dtsAsientoVenta.GeneracionAutomaticaAsientoVenta.Count - 1 - m
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                cnnConexion.Open()
                sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento) " & _
                " VALUES(" & pNumAsiento & ",'" & .Codigo & "','" & .Descripcion & "'," & FormatoDouble(.Haber) & ",0,1,'Asiento automático ajuste de cuenta por pagar crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "') "
                clsConexion.SlqExecute(cnnConexion, sql)
                cnnConexion.Close()
            End With
        Next
...
#Region "Funciones Llenar"
 ...
 " (  " & _
 " SELECT ISNULL(SUM(DC.Ajuste*(DC.Ajuste/dc.Ajuste_sumoneda)) ,0) " & _
 " FROM seepos.dbo.Ajustescpagar AC, seepos.dbo.Detalle_AjustescPagar DC " & _
