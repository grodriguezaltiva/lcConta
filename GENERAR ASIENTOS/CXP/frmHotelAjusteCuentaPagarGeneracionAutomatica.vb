...
Public Class frmHotelAjusteCuentaPagarGeneracionAutomatica
...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmHotelAjusteCuentaPagarGeneracionAutomatica))
        ...
        Me.TituloModulo.Size = New System.Drawing.Size(628, 32)
        Me.TituloModulo.Text = "Ajuste cuenta por pagar"
        '
        'ToolBarEliminar
        '
        ...
        Me.ToolBar1.Size = New System.Drawing.Size(628, 52)
        ...
        Me.txtUsuario.Location = New System.Drawing.Point(424, 394)
        ...
        Me.txtClave.Location = New System.Drawing.Point(344, 394)
        ...
        Me.btnGenerarCostoVenta.Location = New System.Drawing.Point(368, 70)
        ...
        Me.btnGenerarCostoVenta.Text = "Generar asiento crédito"
        '
        'griDetalle
        '
        ...
        Me.griDetalle.Location = New System.Drawing.Point(16, 101)
        Me.griDetalle.MainView = Me.GridView1
        Me.griDetalle.Name = "griDetalle"
        Me.griDetalle.Size = New System.Drawing.Size(600, 233)
        ...
        Me.Label9.Location = New System.Drawing.Point(424, 378)
        ...
        Me.Label10.Location = New System.Drawing.Point(344, 378)
        ...
        'btnGenerarVenta
        '
        Me.btnGenerarVenta.Location = New System.Drawing.Point(368, 38)
        ...
        Me.btnGenerarVenta.Text = "Generarar asiento débito"
        '
        'dtpFechaFinal
        '
        Me.dtpFechaFinal.Format = System.Windows.Forms.DateTimePickerFormat.Short
        Me.dtpFechaFinal.Location = New System.Drawing.Point(248, 70)
        ...
        Me.dtpFechaInicio.Location = New System.Drawing.Point(248, 38)
        ...
        '
        'frmHotelAjusteCuentaPagarGeneracionAutomatica
        '
        ...
        Me.Name = "frmHotelAjusteCuentaPagarGeneracionAutomatica"
        Me.Text = "Ajuste cuenta por pagar: Generación automática de asiento"
...
#Region "Variables"
    ...
    Dim IdCuenta1(1) As String  ' saber los ids de las cuentas que correspondes a los asientos de venta guardadas en la tabla de Contabilidad.SettingCuentaFacturaVenta
...
#Region "Funciones GUI"
    ...
    Private Sub btnGenerarCostoVenta_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles btnGenerarCostoVenta.KeyDown
        If e.KeyCode = Keys.Enter Then
            GenerarCredito()
        End If
    End Sub
...
#Region "Funciones Basicas"
    ...
    Private Function Buscar() As Boolean
        ...
        If caso = 0 Then
            ...
            sql = " SELECT Cod_Proveedor FROM proveeduria.dbo.Ajustescpagar AP, proveeduria.dbo.Detalle_AjustescPagar DP " & _
        "WHERE AP.Id_ajuste = DP.Id_AjustecPagar AND DP.TipoNota = 'DEB' AND Anula = 0 and ContaDeb = 0 " & _
        "AND AP.fecha >= " & fecIni & " AND AP.fecha <= " & fecFin & " GROUP BY AP.Cod_Proveedor"
            ...
            sql = " SELECT c.id " & _
    " FROM proveeduria.dbo.Ajustescpagar AP, proveeduria.dbo.Detalle_AjustescPagar DP " & _
    " ,contabilidad.dbo.cuentacontable c " & _
    " WHERE DP.TipoNota = 'DEB' AND Anula = 0 and ContaDeb = 0 " & _
    "  AND AP.fecha >= " & fecIni & _
    "  and AP.fecha <= " & fecFin & _
    " and  AP.Id_ajuste = DP.Id_AjustecPagar " & _
    " and c.cuentacontable = DP.cuentacontable  COLLATE Traditional_Spanish_CI_AS " & _
    " GROUP BY c.id "
        ...
        If caso = 1 Then
            ...
            sql = " SELECT Cod_Proveedor FROM proveeduria.dbo.Ajustescpagar AP, proveeduria.dbo.Detalle_AjustescPagar DP " & _
        "WHERE AP.Id_ajuste = DP.Id_AjustecPagar AND DP.TipoNota = 'CRE' AND Anula = 0 and ContaCre = 0 " & _
        "AND AP.fecha >= " & fecIni & " AND AP.fecha <= " & fecFin & " GROUP BY AP.Cod_Proveedor"
    ...
    " FROM proveeduria.dbo.Ajustescpagar AP, proveeduria.dbo.Detalle_AjustescPagar DP " & _
    " ,contabilidad.dbo.cuentacontable c " & _
    " WHERE DP.TipoNota = 'CRE' AND Anula = 0 and ContaCre = 0 " & _
    "  AND AP.fecha >= " & fecIni & _
    "  and AP.fecha <= " & fecFin & _
    " and  AP.Id_ajuste = DP.Id_AjustecPagar " & _
    " and c.cuentacontable = DP.cuentacontable  COLLATE Traditional_Spanish_CI_AS " & _
    ...
    Private Sub GenerarDebito()
        ...
        If Buscar() = False Then
            MsgBox("No se encontraron ajustes de cuentas por pagar de debito para esta fecha")
            Exit Sub
        End If
    ...
    Private Sub GenerarCredito()
        ...
        caso = 1
        If Buscar() = False Then
            MsgBox("No se encontraron ajustes de cuentas por pagar de crédito para esta fecha")
            Exit Sub
        End If
    ...
    Private Sub RegistrarAsiento1()
        ...
        If MsgBox("Desea Guardar asiento de Ajuste CXC", MsgBoxStyle.OKCancel) = MsgBoxResult.Cancel Then
            Exit Sub
        End If
        Dim clsConexion As New Conexion
        Dim cnnConexion As New System.Data.SqlClient.SqlConnection
...
" VALUES('" & NumAsiento & "','" & dtpFechaFinal.Value.Date & "',9999,'',24, " & _
" '" & Accion & "',0,'" & Date.Now.Date & "',0,'" & periodo & "',0, " & _
" 'Asiento ajuste de cuenta por pagar','Asiento automático ajuste de cuenta por pagar débito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & "," & Fx.TipoCambio(dtpFechaFinal.Value) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE proveeduria.dbo.Ajustescpagar SET ContaDeb = 1 ,AsientoDeb  = '" & NumAsiento & "'  WHERE ContaDeb = 0 AND anula = 0 AND " & _
        ...
        For n = 0 To Me.dtsAsientoVenta.GeneracionAutomaticaAsientoVenta.Count - 1
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                If monto <> 0 Then
                    ...
                    " VALUES('" & pNumAsiento & "','" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático ajuste de cuenta por pagar débito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "'," & Fx.TipoCambio(dtpFechaFinal.Value) & ") "
                    clsConexion.SlqExecute(cnnConexion, sql)
                    cnnConexion.Close()
                End If
            End With
...
" Periodo,NumMayorizado,Modulo,Observaciones, " & _
" NombreUsuario,TotalDebe,TotalHaber,TipoCambio) " & _
" VALUES('" & NumAsiento & "','" & dtpFechaFinal.Value.Date & "',9999,'',23, " & _
" '" & Accion & "',0,'" & Date.Now.Date & "',0,'" & periodo & "',0, " & _
" 'Asiento ajuste de cuenta por pagar','Asiento automático ajuste de cuenta por pagar crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "','" & Me.txtUsuario.Text & "' " & _
" ," & MonedaToDouble(Me.txtTotalDebe.Text) & "," & MonedaToDouble(Me.txtTotalHaber.Text) & "," & Fx.TipoCambio(dtpFechaFinal.Value) & ") "
        ...
        cnnConexion.Open()
        sql = " UPDATE proveeduria.dbo.Ajustescpagar SET ContaCre = 1 ,AsientoCre  = '" & NumAsiento & "'  WHERE ContaCre = 0 AND anula = 0 AND " & _
                  " fecha >= " & fecIni & " and fecha <= " & fecFin
        clsConexion.SlqExecute(cnnConexion, sql)
        cnnConexion.Close()
        ...
        For n = 0 To Me.dtsAsientoVenta.GeneracionAutomaticaAsientoVenta.Count - 1
            With dtsAsientoVenta.GeneracionAutomaticaAsientoVenta(n)
                ...
                If monto <> 0 Then
                    cnnConexion.Open()
                    sql = " insert into DetallesAsientosContable (NumAsiento,Cuenta,NombreCuenta,Monto,Debe,Haber,DescripcionAsiento,tipocambio) " & _
                    " VALUES('" & pNumAsiento & "','" & .Codigo & "','" & .Descripcion & "'," & monto & "," & debe & "," & haber & ",'Asiento automático ajuste de cuenta por pagar crédito desde: " & Me.dtpFechaInicio.Value.Date & " hasta: " & Me.dtpFechaFinal.Value.Date & "'," & Fx.TipoCambio(dtpFechaFinal.Value) & ") "
                    clsConexion.SlqExecute(cnnConexion, sql)
                    cnnConexion.Close()
                End If
            End With
...
#Region "Funciones Llenar"
    ...
    Private Sub LlenarGriDetalleAsiento1()
        Try
            ...
            sql = ""
            For n = 0 To Me.IdCuenta2.Length - 2
                If n <> 0 Then sql = sql & " UNION "
                sql = sql & " ( " & _
                " select " & (n + 1) & " AS ID, C.CuentaContable AS Codigo,C.Descripcion, " & _
                " (  " & _
                " SELECT ISNULL(SUM((CASE AC.Cod_Moneda WHEN 1 THEN DC.Ajuste ELSE (dc.Ajuste *  " & Fx.TipoCambio(dtpFechaFinal.Value) & " ) END)) ,0) " & _
                " FROM proveeduria.dbo.Ajustescpagar AC, proveeduria.dbo.Detalle_AjustescPagar DC " & _
                " WHERE DC.TipoNota  = 'DEB' AND Anula = 0 and ContaDeb = 0 " & _
                "  AND AC.fecha >=  " & fecIni & _
                "  and AC.fecha <=  " & fecFin & _
                " and  AC.Id_ajuste = DC.Id_AjustecPagar " & _
        ...
        "  and AC.fecha <=  " & fecFin & _
        " and  AC.Id_ajuste = DC.Id_AjustecPagar " & _
        " AND AC.Cod_Proveedor = P.CodigoProv)  " & _
        "  as haber " & _
        " from  Contabilidad.dbo.CuentaContable C, Proveeduria.dbo.Proveedores P  " & _
        " where C.CuentaContable COLLATE Traditional_Spanish_CI_AS = P.CuentaContable AND P.CodigoProv = " & IdCuenta1(n) & _
        " GROUP BY C.CuentaContable,C.Descripcion, P.CodigoProv " & _
        " ) "
            Next
    ...
    Private Sub LlenarGriDetalleAsiento2()
        ...
        sql = ""
        For n = 0 To Me.IdCuenta1.Length - 2
            If n <> 0 Then sql = sql & " UNION "
            sql = sql & " ( " & _
    " select " & (n + 1) & " AS ID, C.CuentaContable AS Codigo,C.Descripcion," & _
    " (  " & _
    " SELECT ISNULL(SUM((CASE AC.Cod_Moneda WHEN 1 THEN DC.Ajuste ELSE (dc.Ajuste *  " & Fx.TipoCambio(dtpFechaFinal.Value) & " ) END)) ,0) " & _
    " FROM proveeduria.dbo.Ajustescpagar AC, proveeduria.dbo.Detalle_AjustescPagar DC " & _
    " WHERE DC.TipoNota  = 'CRE' AND Anula = 0 and ContaCre = 0 " & _
    "  AND AC.fecha >=  " & fecIni & _
    "  and AC.fecha <=  " & fecFin & _
    " and  AC.Id_ajuste = DC.Id_AjustecPagar " & _
    " AND AC.Cod_Proveedor = P.CodigoProv)  " & _
...
#Region "Reporte"
    ...
    Private Sub Reporte()
        Try
            Dim reporte As New rptHotelDetalleAjusteCxP
            ...
            If caso = 1 Then
                reporte.RecordSelectionFormula = " {Ajustescpagar.anula} = false and {Ajustescpagar.contaCre}= false and {Detalle_AjustescPagar.TipoNota}= 'CRE' and {Ajustescpagar.Fecha} in " & fecIni & " to " & fecFin
            Else
                reporte.RecordSelectionFormula = " {Ajustescpagar.anula} = false and {Ajustescpagar.contaDeb}= false and {Detalle_AjustescPagar.TipoNota}= 'DEB' and {Ajustescpagar.Fecha} in " & fecIni & " to " & fecFin
            End If
