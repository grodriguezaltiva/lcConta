...
Public Class AnaliticoGeneral1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.AnaliticoGeneral1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Simb() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAnaliticoGeneral1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnaliticoGeneral1 = New AnaliticoGeneral1()
        rpt.Site = Me.Site
        Return rpt
    End Function
