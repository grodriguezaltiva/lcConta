...
Public Class ReporteCheque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.ReporteCheque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteCheque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCheque = New ReporteCheque()
        rpt.Site = Me.Site
        Return rpt
    End Function
