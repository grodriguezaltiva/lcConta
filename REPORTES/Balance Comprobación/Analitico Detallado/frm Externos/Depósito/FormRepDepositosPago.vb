...
#End Region
    ...
    Private Sub ButtonMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonMostrar.Click
        ...
        Utilidades.cFunciones.Llenar_Tabla_Generico(sql & " " & where, Me.DsReporteD1.PagoDep, GetSetting("SeeSoft", "Hotel", "Conexion"))
    ...
    Private Sub FormRepDepositosPago_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Utilidades.cFunciones.Llenar_Tabla_Generico(sql, Me.DsReporteD1.Bancos, GetSetting("SeeSoft", "Bancos", "Conexion"))
        sql = "Select * From Cliente"

        Utilidades.cFunciones.Llenar_Tabla_Generico(sql, Me.DsReporteD1.Cliente, GetSetting("SeeSoft", "Hotel", "Conexion"))

    End Sub

    Private Sub ButtonPrine_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPrine.Click
        Dim visor As New Utilidades.frmVisorReportes
