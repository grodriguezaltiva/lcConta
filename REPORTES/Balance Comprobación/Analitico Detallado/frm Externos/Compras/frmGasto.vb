...
#Region " Código generado por el Diseñador de Windows Forms "
	...
	Public WithEvents TxtNombreUsuario As Label
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
		...
		Me.GridColumn10.FilterInfo = ColumnFilterInfo1
		...
		Me.GridColumn11.FilterInfo = ColumnFilterInfo2
		...
		Me.GridColumn15.FilterInfo = ColumnFilterInfo3
		...
		'EditDescripcionCC
		'
		Me.EditDescripcionCC.DataBindings.Add(New System.Windows.Forms.Binding("EditValue", Me.dtsGasto, "CentroCosto_Movimientos.Descripcion", True))
		...
		Me.EditDescripcionCC.Size = New System.Drawing.Size(216, 23)
		...
		'CBCentroCosto
		'
		Me.CBCentroCosto.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.dtsGasto, "CentroCosto_Movimientos.IdCentroCosto", True))
		...
		'txtMontoCentroCosto
		'
		Me.txtMontoCentroCosto.DataBindings.Add(New System.Windows.Forms.Binding("EditValue", Me.dtsGasto, "CentroCosto_Movimientos.Monto", True))
		...
		Me.GridColumn3.FilterInfo = ColumnFilterInfo6
		...
		Me.GridColumn4.FilterInfo = ColumnFilterInfo7
		...
		Me.GridColumn5.FilterInfo = ColumnFilterInfo9
		...
		Me.GridColumn6.FilterInfo = ColumnFilterInfo10
		...
		Me.GridColumn7.FilterInfo = ColumnFilterInfo11
		...
		Me.GridColumn9.FilterInfo = ColumnFilterInfo12
	...
	";persist security info=False;initial catalog=Contabilidad"
		...
		Me.SqlInsertCommand8.Parameters.AddRange(New System.Data.SqlClient.SqlParameter() {New System.Data.SqlClient.SqlParameter("@NumAsiento", System.Data.SqlDbType.VarChar, 15, "NumAsiento"), New System.Data.SqlClient.SqlParameter("@Cuenta", System.Data.SqlDbType.VarChar, 255, "Cuenta"), New System.Data.SqlClient.SqlParameter("@NombreCuenta", System.Data.SqlDbType.VarChar, 250, "NombreCuenta"), New System.Data.SqlClient.SqlParameter("@Monto", System.Data.SqlDbType.Float, 8, "Monto"), New System.Data.SqlClient.SqlParameter("@Debe", System.Data.SqlDbType.Bit, 1, "Debe"), New System.Data.SqlClient.SqlParameter("@Haber", System.Data.SqlDbType.Bit, 1, "Haber"), New System.Data.SqlClient.SqlParameter("@DescripcionAsiento", System.Data.SqlDbType.VarChar, 255, "DescripcionAsiento"), New System.Data.SqlClient.SqlParameter("@Tipocambio", System.Data.SqlDbType.Float, 8, "Tipocambio")})
		'
		'SqlSelectCommand9
		'
		Me.SqlSelectCommand9.CommandText = "SELECT ID_Detalle, NumAsiento, Cuenta, NombreCuenta, Monto, Debe, Haber, Descripc" &
...
#Region "Funciones Basicas"
    ...
    Private Sub BuscarEncabezado(ByVal pIdGasto As Double)
        ...
        sql = "SELECT Factura,CodigoProv,Fecha,TipoCompra,Cod_MonedaCompra,Asiento FROM dbo.Compras  WHERE ID_Compra = " & pIdGasto
    ...
    Private Sub AgregarEncabezadoBD()
        ...
        If IdGasto = -1 Then
            sql = " INSERT INTO Compras (Factura,CodigoProv,SubTotalGravado,SubTotalExento,Descuento,Impuesto" &
                " ,TotalFactura, Fecha,Vence,FechaIngreso,Gasto,TipoCompra,Cod_MonedaCompra,TipoCambio) " &
                " VALUES (" & txtNumeroFactura.Text & "," & idProveedor(cmbProveedor.SelectedIndex) & "," &
                Grabado & "," & exento & "," & TotalDescuento & "," &
                TotalImpuesto & "," & Total & ",'" & dtpFecha.Value.Date & "','" &
        ...
        For n = 0 To Me.dtsGasto.GastoDetalle.Count - 1
            With dtsGasto.GastoDetalle(n)
                sql = "INSERT INTO Articulos_Gastos(IdCompra,Descripcion,Base,Costo,Cantidad,Gravado,Exento," &
                        "Descuento_p,Descuento,Impuesto_p,Impuesto,Total,NuevoCostoBase,CuentaContable, CodTipoCompra, DescTipoCompra)" &
...
#Region "Funciones Validar"
    ...
    Private Function ValidarModificarElimar() As Boolean
        ...
        cnnConexion.ConnectionString = Configuracion.Claves.Conexion("Proveeduria")
        cnnConexion.Open()
        sql = " select Contabilizado, Asiento from compras where (Contabilizado = 1 or facturacancelado = 1  " &
...
#Region "Funciones Cargar"
    ...
    Private Sub CargarGridDetalle(ByVal pIdGasto)
        ...
        sql = " SELECT  A.Id_ArticuloComprados AS IdDetalle, A.Cantidad,A.IdCompra,A.Gravado, " &
" A.Exento,A.Descuento,A.Impuesto,A.Total,A.CuentaContable, " &
" A.Impuesto_p,A.NuevoCostoBase,A.Costo,A.CodTipoCompra, A.DescTipoCompra, A.Descuento_P ,A.Descripcion, " &
" c.Descripcion as CuentaContableDescripcion " &
