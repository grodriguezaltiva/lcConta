...
Partial Public Class dtsAnaliticoDetallado
    ...
    Partial Public Class TemporalAnaliticoDetalladoDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddTemporalAnaliticoDetalladoRow(ByVal Fecha As Date, ByVal NumAsiento As String, ByVal Moneda As Integer, ByVal TipoCambio As Double, ByVal Observaciones As String, ByVal TipoDoc As Integer, ByVal NumDoc As String, ByVal Debitos As Double, ByVal Creditos As Double, ByVal SaldoAnterior As Double, ByVal SaldoActual As Double, ByVal CuentaContable As String, ByVal NombreCuenta As String, ByVal Beneficiario As String, ByVal NoDocumentoDetalle As String) As TemporalAnaliticoDetalladoRow
            Dim rowTemporalAnaliticoDetalladoRow As TemporalAnaliticoDetalladoRow = CType(Me.NewRow,TemporalAnaliticoDetalladoRow)
            Dim columnValuesArray() As Object = New Object() {Fecha, NumAsiento, Moneda, TipoCambio, Observaciones, TipoDoc, NumDoc, Debitos, Creditos, SaldoAnterior, SaldoActual, CuentaContable, NombreCuenta, Beneficiario, NoDocumentoDetalle}
        ...
        Private Sub InitClass()
            ...
            Me.columnNoDocumentoDetalle.MaxLength = 50
        End Sub
    ...
    Partial Public Class TemporalAnaliticoDetalladoRow
        ...
        Public Property NoDocumentoDetalle() As String
            Get
                Return CType(Me(Me.tableTemporalAnaliticoDetallado.NoDocumentoDetalleColumn),String)
            End Get
            Set
                Me(Me.tableTemporalAnaliticoDetallado.NoDocumentoDetalleColumn) = value
            End Set
        End Property
    End Class
