...
Public Class ResultadosPeriodo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.ResultadosPeriodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedResultadosPeriodo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ResultadosPeriodo = New ResultadosPeriodo()
        rpt.Site = Me.Site
        Return rpt
    End Function
