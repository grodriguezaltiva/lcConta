...
Public Class EstadoResultad1p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.EstadoResultad1p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstadoResultad1p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstadoResultad1p = New EstadoResultad1p()
        rpt.Site = Me.Site
        Return rpt
    End Function
