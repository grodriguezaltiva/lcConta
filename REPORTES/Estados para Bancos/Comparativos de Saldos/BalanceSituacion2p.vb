...
Public Class BalanceSituacion2p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.BalanceSituacion2p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalanceSituacion2p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalanceSituacion2p = New BalanceSituacion2p()
        rpt.Site = Me.Site
        Return rpt
    End Function
