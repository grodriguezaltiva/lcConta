...
Public Class EstadoResultad2p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.EstadoResultad2p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstadoResultad2p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstadoResultad2p = New EstadoResultad2p()
        rpt.Site = Me.Site
        Return rpt
    End Function
