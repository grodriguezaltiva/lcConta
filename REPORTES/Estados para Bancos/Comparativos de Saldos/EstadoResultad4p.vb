...
Public Class EstadoResultad4p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.EstadoResultad4p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstadoResultad4p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstadoResultad4p = New EstadoResultad4p()
        rpt.Site = Me.Site
        Return rpt
    End Function
