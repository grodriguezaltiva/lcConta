...
Public Class BalanceSituacion3p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.BalanceSituacion3p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalanceSituacion3p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalanceSituacion3p = New BalanceSituacion3p()
        rpt.Site = Me.Site
        Return rpt
    End Function
