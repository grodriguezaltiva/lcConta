...
Public Class EstadoResultad5p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.EstadoResultad5p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstadoResultad5p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstadoResultad5p = New EstadoResultad5p()
        rpt.Site = Me.Site
        Return rpt
    End Function
