...
Public Class BalanceSituacion4p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.BalanceSituacion4p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalanceSituacion4p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalanceSituacion4p = New BalanceSituacion4p()
        rpt.Site = Me.Site
        Return rpt
    End Function
