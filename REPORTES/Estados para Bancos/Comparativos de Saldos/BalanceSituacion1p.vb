...
Public Class BalanceSituacion1p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.BalanceSituacion1p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalanceSituacion1p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalanceSituacion1p = New BalanceSituacion1p()
        rpt.Site = Me.Site
        Return rpt
    End Function
