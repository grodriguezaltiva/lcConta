...
Public Class BalanceSituacionDolarYColon1P
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "BalanceSituacionDolarYColon1P.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.BalanceSituacionDolarYColon1P.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalanceSituacionDolarYColon1P
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalanceSituacionDolarYColon1P = New BalanceSituacionDolarYColon1P()
        rpt.Site = Me.Site
        Return rpt
    End Function
