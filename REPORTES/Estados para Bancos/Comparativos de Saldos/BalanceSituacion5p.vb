...
Public Class BalanceSituacion5p
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.BalanceSituacion5p.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalanceSituacion5p
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalanceSituacion5p = New BalanceSituacion5p()
        rpt.Site = Me.Site
        Return rpt
    End Function
