...
Public Class EstadosR_Renovado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.EstadosR-Renovado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEstadosR_Renovado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EstadosR_Renovado = New EstadosR_Renovado()
        rpt.Site = Me.Site
        Return rpt
    End Function
