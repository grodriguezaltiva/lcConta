...
#Region "Cargar Asientos"
    Sub CargarAsientos(ByVal FechaInicio As String)
    ...
    Sub CargarAsientos1(ByVal FechaInicio As String)
    ...
    Sub CargarDebitos(ByVal FechaInicio As String, ByVal FechaFinal As String)
...
" GROUP BY dbo.AsientoDC_DH.Cuenta, dbo.CuentaContable.Descripcion "
    ...
    Sub CargarDebitos1(ByVal FechaInicio As String, ByVal FechaFinal As String)
        Dim cnnv As SqlConnection = Nothing
        Dim cConexion As New Conexion
        Dim funcion As New cFunciones
        Dim Debe, Haber, Monto As Double
