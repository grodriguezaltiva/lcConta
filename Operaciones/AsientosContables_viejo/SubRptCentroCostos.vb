...
Public Class SubRptCentroCostos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.SubRptCentroCostos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSubRptCentroCostos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRptCentroCostos = New SubRptCentroCostos()
        rpt.Site = Me.Site
        Return rpt
    End Function
