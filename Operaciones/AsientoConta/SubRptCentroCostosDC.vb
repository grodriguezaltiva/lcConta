...
Public Class SubRptCentroCostosDC
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "SubRptCentroCostosDC.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.SubRptCentroCostosDC.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NumAsiento() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSubRptCentroCostosDC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SubRptCentroCostosDC = New SubRptCentroCostosDC()
        rpt.Site = Me.Site
        Return rpt
    End Function
