    ...
    Sub ComprobarArchivoTemporal()
        ...
        If System.IO.File.Exists(Ruta & "tempAsiento.xml") Then
            ...
            If r = MsgBoxResult.Yes Then
                cargarTemporal()
            Else
                System.IO.File.Delete(Ruta & "tempAsiento.xml")
            End If
        End If
    End Sub
...
#End Region
    ...
    Sub cargaTabla()
        Me.TablaAsiento.Clear()
        For Each f As DataSetAsientos.DetallesAsientosContableRow In Me.DataSetAsientos1.DetallesAsientosContable
            dr = Me.TablaAsiento.NewRow
...
#Region "Buscar"
    ...
    Sub LlenarAsiento(ByVal Id As String)
    ...
    Sub LlenarAsientoDetalle(ByVal Id As String)
        Dim cnnv As SqlConnection = Nothing
        'Dentro de un Try/Catch por si se produce un error
        Try
...
#End Region
    ...
    Sub salvarTemporal()
        ...
        Me.DataSetAsientos1.WriteXml(Ruta & "tempAsiento.xml", XmlWriteMode.DiffGram)
        Me.DataSetAsientos1.DetallesAsientosContable.Clear()
    End Sub
