...
Public Class ListadoAsientos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.ListadoAsientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListadoAsientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListadoAsientos = New ListadoAsientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
