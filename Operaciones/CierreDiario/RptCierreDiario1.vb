...
Public Class RptCierreDiario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.RptCierreDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdCierre() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptCierreDiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptCierreDiario = New RptCierreDiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
