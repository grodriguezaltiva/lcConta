...
Public Class Encabezado_Reportes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Encabezado_Reportes.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Contabilidad.Encabezado_Reportes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEncabezado_Reportes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Encabezado_Reportes = New Encabezado_Reportes()
        rpt.Site = Me.Site
        Return rpt
    End Function
